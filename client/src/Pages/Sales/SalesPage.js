...
//         <Typography variant="h4" gutterBottom component="div" sx={{ mt: 3, mb: 3 }}> Sales Page</Typography>
...
function SalesPage() {
  ...
  const handleCheckout = async () => {
    ...
    const transaction = {
      ...
      totalAmount,
      paymentMethod,
      transactionDate: currentDateTime, // Add current date and time to the transaction
    };
