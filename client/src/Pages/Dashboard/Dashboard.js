...
// //         totalItemsSold: Number(response.data.totalItemsSold) || 0
// //       });
// //     } catch (error) {
// //       console.error('Error fetching dashboard data:', error);
// //       setError("Failed to load dashboard data. Please try again later.");
...
// //       "customerUpdated",
// //       "productUpdated",
// //       "billUpdated" // Changed from transactionUpdated to billUpdated
// //     ];
...
// //           value={`Rs.${stats.totalSalesAmount.toFixed(2)}`} 
// //         />
// //         <StatsCard 
